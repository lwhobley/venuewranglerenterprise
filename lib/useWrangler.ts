...
export type WranglerAction = { id: string; type: 'NAVIGATE' | 'ACKNOWLEDGE' | 'NOTIFY_STAFF'; label: string; route: '/reservations' | '/staff' | '/schedule' | '/bar-stock' | '/reports' | '/floor' | '/inventory'; requiresConfirmation: boolean; payload?: Record<string, string | number | boolean | null> };
