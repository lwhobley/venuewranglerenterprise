...
Exceptions: `Follow-up required`, `Disputed`, `Finalization failed`. A closed event supports only controlled post-close corrections that append history and may reopen affected reporting, never erase original records.
