...
describe('API health RLS gate', () => {
  it('reports healthy only when the runtime role and all protected tables enforce RLS', async () => {
    ...
    const controller = controllerFor(
      ...
      { protected: true, table_count: 23n, policy_table_count: 23n },
    );
  ...
  it.each([
    ['a superuser runtime role', { rolsuper: true, rolbypassrls: false }, { protected: true, table_count: 23n, policy_table_count: 23n }],
    ['a BYPASSRLS runtime role', { rolsuper: false, rolbypassrls: true }, { protected: true, table_count: 23n, policy_table_count: 23n }],
    ['an unprotected application table', { rolsuper: false, rolbypassrls: false }, { protected: false, table_count: 23n, policy_table_count: 23n }],
