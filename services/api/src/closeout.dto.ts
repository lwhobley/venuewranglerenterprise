...
export class UpdateCloseoutFollowupDto {
  @IsIn(['ISSUE', 'TASK', 'ATTENDANCE', 'HOSPITALITY', 'STOCK_COUNT', 'STOCK_TRANSFER', 'STOCK_PURCHASE_ORDER', 'VENDOR_REQUEST']) sourceType!: 'ISSUE' | 'TASK' | 'ATTENDANCE' | 'HOSPITALITY' | 'STOCK_COUNT' | 'STOCK_TRANSFER' | 'STOCK_PURCHASE_ORDER' | 'VENDOR_REQUEST';
...
export class CreatePostCloseCorrectionDto {
  @IsIn(['EVENT', 'ISSUE', 'TASK', 'ATTENDANCE', 'HOSPITALITY', 'STOCK_COUNT', 'STOCK_TRANSFER', 'STOCK_PURCHASE_ORDER', 'VENDOR_REQUEST']) sourceType!: 'EVENT' | 'ISSUE' | 'TASK' | 'ATTENDANCE' | 'HOSPITALITY' | 'STOCK_COUNT' | 'STOCK_TRANSFER' | 'STOCK_PURCHASE_ORDER' | 'VENDOR_REQUEST';
  @IsUUID() sourceId!: string;
